...
const SEARCH_ITEMS = [
  ...
  { label: "Court Cases",    href: "/court-cases",  category: "Management", icon: Gavel,          keywords: ["court","case","hearing","tarikh"] },
  { label: "Chamber",        href: "/chamber",      category: "Management", icon: LayoutDashboard,keywords: ["chamber","matter","deadline","calendar"] },
