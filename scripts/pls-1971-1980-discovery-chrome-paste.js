/*
 * PakistanLawSite 1971-1980 worklist discovery launcher.
 *
 ...
 *   D:\AI legal System\ai-legal-system\scripts\Start PLS 1971-1980 Worklist Discovery.bat
 */
(function pls1971To1980DiscoveryLauncher() {
  "use strict";

  var CONFIG = {
    api: "http://127.0.0.1:8780",
    years: "1971-1980",
    serverStartHint: 'Run this in PowerShell/CMD, not Chrome: "D:\\AI legal System\\ai-legal-system\\scripts\\Start PLS 1971-1980 Worklist Discovery.bat"'
  };

  function overlay(message, tone) {
    var box = document.getElementById("codex-pls-1971-1980-discovery-status");
    if (!box) {
      box = document.createElement("div");
      box.id = "codex-pls-1971-1980-discovery-status";
      box.style.cssText = [
        "position:fixed",
        "z-index:2147483647",
        "left:14px",
  ...
  function validateServer(status) {
    if (!status || status.from !== 1971 || status.to !== 1980) {
      overlay(
        "Local discovery server is not serving 1971-1980.\n"
