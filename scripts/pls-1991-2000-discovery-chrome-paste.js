/*
 * PakistanLawSite 1991-2000 worklist discovery launcher.
 *
 ...
 *   D:\AI legal System\ai-legal-system\scripts\Start PLS 1991-2000 Worklist Discovery.bat
 */
(function pls1991To2000DiscoveryLauncher() {
  "use strict";

  var CONFIG = {
    api: "http://127.0.0.1:8790",
    years: "1991-2000",
    serverStartHint: 'Run this in PowerShell/CMD, not Chrome: "D:\\AI legal System\\ai-legal-system\\scripts\\Start PLS 1991-2000 Worklist Discovery.bat"'
  };

  function overlay(message, tone) {
    var box = document.getElementById("codex-pls-1991-2000-discovery-status");
    if (!box) {
      box = document.createElement("div");
      box.id = "codex-pls-1991-2000-discovery-status";
      box.style.cssText = [
        "position:fixed",
        "z-index:2147483647",
        "left:14px",
  ...
  function validateServer(status) {
    if (!status || status.from !== 1991 || status.to !== 2000) {
      overlay(
        "Local discovery server is not serving 1991-2000.\n"
